    ...
    return (
        <main className='main-box'>
            ...
            <div className='main-box-right'>
                ...
                <div className='btn-1'>
                    <button type='button' aria-label="Next Page" onClick={handleClick}><FaAngleRight className='btn-content' /></button>
                </div>
            </div>
            <div className='main-box-left'>
                <motion.img src="/images/Saly-16.webp" className='h-imge' alt="3D Illustration" width="1050" height="772" fetchPriority="high"
